...
#getSymbols('GS', src='yahoo', from='2015-1-01', to='2016-1-1')
getSymbols('GS', src='yahoo', from='2005-1-01', to='2015-1-1')
#getSymbols('GS', src='yahoo', from='2011-1-01', to='2016-2-1')
...
fProfitDataMA <- function(x, timeShort, timeLong)
{
  ...
  # plot stuff
  plot(currentProfitShort,type='l',col='orange',fg='white',main=paste(timeShort, '- day WMA Current Profit'))
  
  plot(overallProfitShort,type='l',col='green',fg='white',main=paste(timeShort, '- day WMA Total Profit'))
  
  plot(currentProfitLong,type='l',col='orange',fg='white',main=paste(timeLong, '- day WMA Current Profit'))
...
fProfitCrossMA <- function(x, timeShort, timeLong)
{
  ...
  plot(currentProfit,type='l',col='orange',fg='white',main=paste('Current Profit'))
...
fProfitDataMAMult <- function(x, timePeriod, percentBuy = 0, buyCap = 100)
{
  ...
  # plot stuff
  plot(currentProfitMult,type='l',col='orange',fg='white',main=paste(timePeriod, '- day WMA Current Profit'))
...
fProfitDataMAMult(mAvgsAll(X,25,95,0,1),25,0.02)     #14.38% ROI with GS!!! from='2014-1-01', to='2016-2-1'
                                                     #21.29% ROI with GS!!! from='2010-1-01', to='2016-2-1'
                                                     #33.42% ROI with GS!!! from='2011-1-01', to='2016-2-1'
...
fProfitDataMA(mAvgsAll(X,25,55,0,1),25,55)     # 1.42% ROI with GS!!! from='2014-1-01', to='2016-2-1'
